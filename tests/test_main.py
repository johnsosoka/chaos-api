...
class TestHandleRoot:
    ...
    def test_get_root_returns_response(self, test_client: TestClient, mock_llm_client: MagicMock) -> None:
    ...
    def test_post_root_returns_response(self, test_client: TestClient, mock_llm_client: MagicMock) -> None:
    ...
    def test_put_root_returns_response(self, test_client: TestClient, mock_llm_client: MagicMock) -> None:
    ...
    def test_delete_root_returns_response(self, test_client: TestClient, mock_llm_client: MagicMock) -> None:
    ...
    def test_patch_root_returns_response(self, test_client: TestClient, mock_llm_client: MagicMock) -> None:
...
class TestHandleAnyPath:
    ...
    def test_get_users_returns_response(self, test_client: TestClient, mock_llm_client: MagicMock) -> None:
    ...
    def test_get_nested_path_returns_response(self, test_client: TestClient, mock_llm_client: MagicMock) -> None:
    ...
    def test_query_params_passed_to_llm(self, test_client: TestClient, mock_llm_client: MagicMock) -> None:
    ...
    def test_headers_passed_to_llm(self, test_client: TestClient, mock_llm_client: MagicMock) -> None:
...
class TestMimeTypeHandling:
    ...
    def test_returns_json_by_default(self, test_client: TestClient, mock_llm_client: MagicMock) -> None:
    ...
    def test_returns_xml_when_requested(self, test_client: TestClient, mock_llm_client: MagicMock) -> None:
    ...
    def test_returns_html_when_requested(self, test_client: TestClient, mock_llm_client: MagicMock) -> None:
    ...
    def test_returns_plain_text_when_requested(self, test_client: TestClient, mock_llm_client: MagicMock) -> None:
...
class TestErrorHandling:
    ...
    def test_handles_llm_exception(self, test_client: TestClient, mock_llm_client: MagicMock) -> None:
    ...
    def test_error_response_is_json(self, test_client: TestClient, mock_llm_client: MagicMock) -> None:
...
class TestRequestBodyHandling:
    ...
    def test_json_body_parsed_and_passed(self, test_client: TestClient, mock_llm_client: MagicMock) -> None:
